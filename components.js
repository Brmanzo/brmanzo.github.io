class Header extends HTMLElement {
  connectedCallback() {
    ...
    const basePath = scriptTag ? scriptTag.getAttribute('src').replace('components.js', '') : '';
    
    this.innerHTML = `
    <header>
      <div class="logo">Bradley R Manzo</div>
      <nav>
        <a href="${basePath}index.html">About Me</a>
        <a href="${basePath}Projects/projects.html">Projects</a>
        <a href="${basePath}Work-Experience/work-experience.html">Work Experience</a>
        <a href="${basePath}assets/Bradley_Manzo_resume.pdf">Resume</a>
        <a href="${basePath}tools/image-converter.html">Tools</a>
    ...
    this.innerHTML = `
      <section id="contact" class="container contact">
        ...
        <div class="social-links">
          <a class="icon-link" href="mailto:bmanzo@ucsc.edu" target="_blank" rel="noopener" aria-label="Email">
            <svg width="100" viewBox="130 115 70 70" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a class="icon-link" href="https://github.com/Brmanzo" target="_blank" rel="noopener" aria-label="GitHub">
            <svg width="100" viewBox="0 0 70 70" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a class="icon-link" href="https://www.linkedin.com/in/bradley-r-manzo/" target="_blank" rel="noopener" aria-label="LinkedIn">
            <svg width="100" viewBox="0 0 70 70" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
class Footer extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <footer>
        © <span>${new Date().getFullYear()}</span> Bradley Manzo | Built with HTML + CSS
      </footer>
    `;
  }
}
